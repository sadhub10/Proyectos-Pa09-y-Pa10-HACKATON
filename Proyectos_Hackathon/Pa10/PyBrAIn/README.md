...
- **Visualización de BER (Bit Error Rate)** por tipo de modulación
- **Salud de la señal** por cada resultado
...
- ✅ BER (Bit Error Rate) (ej: 5 x 10^-6)
- ✅ Salud de la señal (Buena/Normal/Mala)
